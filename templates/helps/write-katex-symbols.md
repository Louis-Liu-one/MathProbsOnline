...
在 $\KaTeX$ 公式中，可以使用各种符号。本节将提供大量 $\KaTeX$ 公式中可用的符号，并按照小节分类。你不必——当然也不可能——将它们全部记住，需要时在此处查阅或上网搜索即可。

$\KaTeX$ 公式支持的符号表浩如烟海，本篇帮助仅提供若干常用符号，不胜枚举者，可至[此处](https://katex.org/docs/supported.html)查看。
